...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.8102482361266821; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 9.523570265047368;

        // feedforward parameters (in tick units)
        public double kS = 1.45;
        public double kV = 0.16369628586776147;
        public double kA = 0.0005;

        // path profile parameters (in inches)
        public double maxWheelVel = 175;
        public double minProfileAccel = -30;
        public double maxProfileAccel = 175;
